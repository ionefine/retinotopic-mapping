...
switch s.state
    case 'on';
        ...
        if strcmp(s.action, 'error')
            Screen('FillArc',display.windowPtr,[ 0 0 0 ],s.rect{2},90*(s.show-1)+s.rotAng,90);
       else
             Screen('FillArc',display.windowPtr,s.color{s.show},s.rect{2},90*(s.show-1)+s.rotAng,90);
        end
