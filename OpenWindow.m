...
% 9/22/11 pb added 'debug_small' field -> small psychscreen with access to
% command window
...
%Open the window
if ~isfield(display,'debug_small'), display.debug_small = 0; end
if display.debug_small
    [display.windowPtr,res]=Screen('OpenWindow',display.screenNum,display.bkColor,[0 0 225 143]*3);
else
